const detalleCuenta = (() => {
    ...
    const _actionButtonEditar = async (event) => {
      ...
      formDetalleCuenta.setData(response[0],'PUT');
      formDetalleCuenta.setVisible(true);
      detalleCuenta.setVisible(false);
    };
    ...
    const _configureBtnNuevo = () => {
      ...
      $btnNuevo.addEventListener("click", () => {
        //alert("sTRING HOLA MUNDO")
        detalleCuenta.setVisible(false);
        formDetalleCuenta.setVisible(true);
        // detalleCuenta.setData({},'POST')
      });
    };
